...
def search_posts(request):
    ...
    if query:
        # Using Post.objects.filter with title_icontains, contenticontains, and tagsname_icontains
...
def posts_by_tag(request, tag_name):
    # Using Post.objects.filter with tags_name_icontains
...
def advanced_search(request):
    ...
    if query:
        ...
        posts_by_tags = Post.objects.filter(tags_name_icontains=query)
